...
/> 
    ...
    assert(PixelWidth==PixelHeight)  # Only support square pixels for now
    tif_width=PixelWidth*img.width*1000 # physical width in mm of image as read from .tiff
    tif_height=PixelHeight*img.height*1000 # physical height in mm of image as read from .tiff, including some non-physical height from bar at bottom of image
